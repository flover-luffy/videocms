...
export async function register() {
  if (process.env.NEXT_RUNTIME === "nodejs") {
    ...
    const otlpEndpoint =
      ...
      "http://tracing-cn-guangzhou.arms.aliyuncs.com/adapt_a5dd86x7j5@521f2876e10700c_a5dd86x7j5@53df7ad2afe8301/api/otlp/traces";
    ...
    try {
      ...
      sdk.start();
      console.info("✅ OpenTelemetry 监控已启动，端点:", otlpEndpoint);
    } catch (err: unknown) {
